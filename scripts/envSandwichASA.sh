...
export MH_STARCH_SERVICE_DIR="$MH_PROJECT_DIRECTORY/source-code/$MH_PROJECT_REPO/$MH_STARCH_SERVICE_ID"
export MH_TOPPING_SERVICE_DIR="$MH_PROJECT_DIRECTORY/source-code/$MH_PROJECT_REPO/$MH_TOPPING_SERVICE_ID"
export MH_FOOD_SERVICE_DIR="$MH_PROJECT_DIRECTORY/source-code/$MH_PROJECT_REPO/$MH_FOOD_SERVICE_ID"
